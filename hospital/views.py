...
#for showing signup/login button for admin(by bingo1227)
...
#for showing signup/login button for doctor(by bingo1227)
...
#for showing signup/login button for patient(by bingo1227)
...
#-----------for checking user is doctor , patient or admin(by bingo1227)
def is_admin(user):
